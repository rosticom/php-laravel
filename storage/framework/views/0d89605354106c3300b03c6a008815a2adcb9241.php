...
<?php $__env->startSection('panel'); ?>
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit book: <b><?php echo e($book->name); ?></b></div>
    ...
    <div class="panel-body">
        <?php echo Form::model($book, ['route' => ['book.update', $book->id], 'method' => 'PUT']); ?>


        <?php echo $__env->make('book._form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
