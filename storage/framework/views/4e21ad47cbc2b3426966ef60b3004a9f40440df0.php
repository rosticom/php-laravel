<?php $__env->startSection('panel'); ?>
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit size ID: <b><?php echo e($size->id); ?></b></div>
    ...
    <div class="panel-body">
        ...
        <?php echo $__env->make('size._form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
